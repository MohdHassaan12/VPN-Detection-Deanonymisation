...
# Configuration (In production, load these from environment variables securely)
SECRET_KEY = os.getenv("JWT_SECRET_KEY", "b40d3a5a41be1f3be18fa2fcd5c71b6d0e816a3c9e6bb1a0d7f28bc88f4e6de8")
ALGORITHM = "HS256"
